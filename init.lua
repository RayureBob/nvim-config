...
-- Diagnostic keymaps
vim.keymap.set('n', '<M-Up>', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic message' })
vim.keymap.set('n', '<M-Down>', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic message' })
...
vim.api.nvim_set_keymap('i', '<C-Tab>', '<C-v><Tab>', { noremap=true, silent=true})
vim.keymap.set('n', '<C-Tab>', '<C-v><Tab>')
